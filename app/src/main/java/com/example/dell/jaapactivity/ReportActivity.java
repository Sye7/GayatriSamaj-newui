       ...
       final BarChart lineChart = findViewById(R.id.totalBar);
        ...
        card1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), DeepReport.class);
                intent.putExtra("name",h1.getText());
        ...
        card2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), DeepReport.class);
                intent.putExtra("name",h2.getText());
                startActivity(intent);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), DeepReport.class);
                intent.putExtra("name",h3.getText());
                startActivity(intent);
            }
        });
        ...
        card4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), DeepReport.class);
                intent.putExtra("name",h4.getText());
                startActivity(intent);
            }
        });
        //Day Wise Bar Chart
